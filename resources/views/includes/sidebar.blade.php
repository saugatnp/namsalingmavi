            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item px-3">
                  ...
                  <li class="nav-item dropdown px-3">
                    <a class="nav-link dropdown-toggle " data-toggle="dropdown" href="#" id="dropdownMenuLink" role="button"  aria-expanded="false">
                      ACADEMICS
                    </a>
...
<div class="main-bar">
  ...
  <div class="sidebar">
    ...
    <li class="nav-item dropdown px-3">
      <a class="nav-link dropdown-toggle " href="#" data-toggle="dropdown"id="dropdownMenuLink" role="button"  aria-expanded="false">
        ABOUT US
      </a>
      <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
        <li><a class="dropdown-item" href="/aboutus/schoolprofile">School Profile & History</a></li>
