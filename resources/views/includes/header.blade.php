            ...
            <div class="row text-center text-md-left ">
                <div class="col-md-6">
                    <ul class="list-inline mb-0 py-2">
                        ...
                        <li class="list-inline-item">
                            <a href="https://www.google.com/maps/search/Maijogmai-3, Ilam, Nepal" class="c0132" target="_blank" >
                                <span aria-hidden="true" class="fa fa-map-marker ">
                                </span>
                                Maijogmai-3, Ilam, Nepal
                            </a>
                        </li>
                    </ul>
                </div>
