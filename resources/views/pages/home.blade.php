...
@section('content')
    ...
    <button type="button" id="btnTrigger" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
        style="display: none">
    </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <img style="width: 100%" src="{{asset('storage/images/'.$data->image)}}">
                </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    @foreach ($crouselone as $croone)
                        <img src="{{ asset('storage/images/' . $croone->image) }}" class="d-block w-100" style="opacity: 0.8;"
                            alt="...">
                        <div>
                ...
                <div class="carousel-item">
                    @foreach ($crouseltwo as $crotwo)
                        <img src="{{ asset('storage/images/' . $crotwo->image) }}" class="d-block w-100" style="opacity: 0.8;"
                            alt="...">
                        <div>
                            <h1 class="carousel-content">{{ $croone->title }}</h1>
                        </div>
    ...
    <div class="nrecent">
        @foreach ($recentevent as $data)
            <div class="firstrecent">
                <div class="frimage">
                    <img src="{{ asset('storage/images/' . $data->image) }}" loading="lazy" class="rctimg"
                        alt="recent image">
                </div>
                <div class="frtext">
                    <div>
        ...
        @foreach ($recenteventtwo as $data)
            <div class="secondrecent">
                <div class="frimagetwo">
                    <img src="{{ asset('storage/images/' . $data->image) }}" loading="lazy" class="rctimg2"
                        alt="recent image">
                </div>
                <div class="frtext">
                    <div>
